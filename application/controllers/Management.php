...
class Management extends CI_Controller {
    ...
    public function TTL_KeysPub() {
        ...
        $this->crud->set_subject('Keywors');
        $this->crud->set_relation('RealKey', 'Keyword', 'Name');
    ...
    public function TTL_Publications() {
        ...
        $this->crud->columns('idPublication', 'Title', 'Year', 'DOI', 'Conference_idConference', 'Journal_idJournal');
    ...
    public function TTL_Organization() {
        ...
        $this->crud->columns('idOrganization', 'Name');
        $this->crud->display_as('Name', 'Nombre');
    ...
    public function TTL_Journal() {
        ...
        $this->crud->columns('idJournal', 'FullName', 'ShortName');
    ...
    public function TTL_Conference() {
        ...
        $this->crud->columns('idConference', 'FullName', 'ShortName');
        $this->crud->display_as('FullName', 'Nombre Completo')
                ->display_as('ShortName', 'Nombre Corto');
        $this->crud->set_subject('Conferencias');
        //$this->crud->unset_delete();
        //$this->crud->add_action('Eliminar', '', '','ui-icon-circle-minus',array($this,'just_a_test'));
